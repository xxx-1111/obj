...
<div class="detail">
	...
	<div class="content">
	  <div class="header clear">
			<h2><img :src="detail.detail.auth_icon" alt=""/></h2>
			<p>{{detail.detail.auth}}</p>
		</div>
	  <div class="cont">
	    <h3>{{detail.title}} {{ 9 | fillzero}}</h3>
	    <div class="time"><p>{{detail.time | date}}<span>
			<img src="../assets/img/zan.png" alt=""/></span></p></div>
...
<style>
  ...
  .content{ margin:0 auto; padding-bottom:0.85rem;}
  ...
  .cont .time{height:0.24rem; line-height:0.24rem; margin:0.26rem 0; font-size: 0.4rem;}
